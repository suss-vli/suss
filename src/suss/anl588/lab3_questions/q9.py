...
class Question9A(EqualityCheckProblem):
    ...
    def produce_expected(data):
        produce_expected_code = x.get_produce_expected("lab3", "q9", "q9a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        test_pred = exec_globals['produce_expected'](Question5._expected, data)
        return test_pred
...
class Question9B(EqualityCheckProblem):
    ...
    def produce_expected(x_data, y_data):
        produce_expected_code = x.get_produce_expected("lab3", "q9", "q9b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        scatterplot = exec_globals['produce_expected'](x_data, y_data)
