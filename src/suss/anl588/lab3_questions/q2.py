...
class Question2A(EqualityCheckProblem):
    ...
    def produce_expected(var1, var2, var3, data1, hue1):
        produce_expected_code = x.get_produce_expected("lab3", "q2", "q2a")
        exec_globals = {}

        exec(produce_expected_code, exec_globals)
        pairplot = exec_globals['produce_expected'](var1, var2, var3, data1, hue1)
...
class Question2B(EqualityCheckProblem):
    ...
    def produce_expected(data1, var1, var2):
        produce_expected_code = x.get_produce_expected("lab3", "q2", "q2b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        histplot = exec_globals['produce_expected'](data1, var1, var2)
        return histplot
...
class Question2C(EqualityCheckProblem):
    df = Question1._expected
    def produce_expected(data1, var1, var2):
        produce_expected_code = x.get_produce_expected("lab3", "q2", "q2c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        histplot = exec_globals['produce_expected'](data1, var1, var2)        
        return histplot
