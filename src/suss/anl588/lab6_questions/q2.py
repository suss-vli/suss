...
class Question2A(EqualityCheckProblem):
    ...
    def produce_expected(file):
        ...
        produce_expected_code = x.get_produce_expected("lab6", "q2", "q2a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        dfa = exec_globals['produce_expected'](expected_file)
        return dfa
...
class Question2B(EqualityCheckProblem):
    ...
    def produce_expected(input1):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + 'test_prisons.sav'
        produce_expected_code = x.get_produce_expected("lab6", "q2", "q2b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        dfa = exec_globals['produce_expected'](expected_file, input1)
        return dfa
...
class Question2C(EqualityCheckProblem):
    ...
    def produce_expected(input1):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + 'test_prisons.sav'
        produce_expected_code = x.get_produce_expected("lab6", "q2", "q2c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        dfa = exec_globals['produce_expected'](expected_file, input1)
        return dfa
