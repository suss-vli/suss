...
class Question3A(EqualityCheckProblem):
    ...
    def produce_expected(input1, input2):
        ...
        produce_expected_code = x.get_produce_expected("lab6", "q3", "q3a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        rules_fail = exec_globals['produce_expected'](dfa, input1, input2)
        return rules_fail
...
class Question3B(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab6", "q3", "q3b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        failed_attr = exec_globals['produce_expected']()
