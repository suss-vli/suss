...
class Question4A(EqualityCheckProblem):
    ...
    def produce_expected(file):
        ...
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df_bal3 = exec_globals['produce_expected'](expected_file)
...
class Question4B(EqualityCheckProblem):
    ...
    def produce_expected(file):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + file
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df_bal4 = exec_globals['produce_expected'](expected_file)
        return df_bal4
...
class Question4C(EqualityCheckProblem):
    ...
    def produce_expected(file):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + file
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df_bal5 = exec_globals['produce_expected'](expected_file)
        return df_bal5
...
class Question4D(EqualityCheckProblem):
    ...
    def produce_expected(file):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + file
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4d")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df_bal6 = exec_globals['produce_expected'](expected_file)
        return df_bal6
...
class Question4E(EqualityCheckProblem):
    ...
    def produce_expected(file):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + file
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4e")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df2 = exec_globals['produce_expected'](expected_file)
        return df2
...
class Question4F(EqualityCheckProblem):
    ...
    def produce_expected(column1, column2):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + 'test_UCI_Credit_Card.csv'
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4f")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df2 = exec_globals['produce_expected'](expected_file, column1, column2)
        return df2
...
class Question4G(EqualityCheckProblem):
    ...
    def produce_expected(column1):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + 'test_UCI_Credit_Card.csv'
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4g")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df2 = exec_globals['produce_expected'](expected_file, column1)
...
class Question4H(EqualityCheckProblem):
    ...
    def produce_expected(columns1, columns2):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + 'test_UCI_Credit_Card.csv'
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4h")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df2 = exec_globals['produce_expected'](expected_file, columns1, columns2)
        return df2
...
class Question4I(EqualityCheckProblem):
    ...
    def produce_expected(file, column_no1, column_no2):
        expected_file = os.path.dirname(os.path.abspath(__file__)) + "/" + file
        produce_expected_code = x.get_produce_expected("lab4", "q4", "q4i")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        df2 = exec_globals['produce_expected'](expected_file, column_no1, column_no2)
        return df2
