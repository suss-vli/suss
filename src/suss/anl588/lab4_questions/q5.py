...
class Question5A(EqualityCheckProblem):
    ...
    def produce_expected(input_data):
        produce_expected_code = x.get_produce_expected("lab4", "q5", "q5a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        expected_X = exec_globals['produce_expected'](input_data)
        return expected_X
...
class Question5B(EqualityCheckProblem):
    ...
    X = df2.drop('DEFAULT', axis=1) 
    def produce_expected(input_data):
        produce_expected_code = x.get_produce_expected("lab4", "q5", "q5b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        expected = exec_globals['produce_expected'](input_data)
        return expected
...
class Question5C(EqualityCheckProblem):
    ...
    def produce_expected(input_data1, input_data2):
        produce_expected_code = x.get_produce_expected("lab4", "q5", "q5c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        expected = exec_globals['produce_expected'](input_data1, input_data2)
        return expected
