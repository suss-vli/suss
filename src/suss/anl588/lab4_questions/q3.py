...
class Question3A(EqualityCheckProblem):
    ...
    def produce_expected(xlabel, kind, data1, hue1, alpha1):
        produce_expected_code = x.get_produce_expected("lab4", "q3", "q3a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        catplot = exec_globals['produce_expected'](xlabel, kind, data1, hue1, alpha1)
        return catplot
...
class Question3B(EqualityCheckProblem):
    ...
    def produce_expected(xlabel, ylabel, kind, data1, hue1, palette1):
        produce_expected_code = x.get_produce_expected("lab4", "q3", "q3b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        catplot = exec_globals['produce_expected'](xlabel, ylabel, kind, data1, hue1, palette1)
        return catplot
