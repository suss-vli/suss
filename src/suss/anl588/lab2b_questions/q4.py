...
class Question4A(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q4", "q4a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        Total, Average1 = exec_globals['produce_expected']()        
...
class Question4B(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q4", "q4b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        Average1, Average2 = exec_globals['produce_expected']()
