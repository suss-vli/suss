...
class Question1A(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q1", "q1a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        a1, a2 = exec_globals['produce_expected']()
...
class Question1B(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q1", "q1b")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        myarray = exec_globals['produce_expected']()
        return myarray
...
class Question1C(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q1", "q1c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        myarray_mean = exec_globals['produce_expected']()
        return myarray_mean
