...
class Question2A(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q2", "q2a")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        math, science = exec_globals['produce_expected']()
        return math, science
...
class Question2B(EqualityCheckProblem):
    ...
    _var = 'classnames'
    _expected = ['Abruzzo', 'Todi', 'Umbria', 'Raiano', 'Molise']
    _test_cases = [
...
class Question2C(EqualityCheckProblem):
    ...
    def produce_expected():
        produce_expected_code = x.get_produce_expected("lab2b", "q2", "q2c")
        exec_globals = {}
        exec(produce_expected_code, exec_globals)
        math, science = exec_globals['produce_expected']()
        return math, science
